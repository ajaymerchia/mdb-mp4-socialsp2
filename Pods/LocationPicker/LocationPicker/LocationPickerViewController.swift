...
open class LocationPickerViewController: UIViewController {
	...
	open override func loadView() {
		...
		if showCurrentLocationButton {
            ...
            button.setImage(UIImage(named: "geolocation", in: bundle, compatibleWith: nil), for: .normal)
	...
	open override func viewDidLoad() {
        ...
        navigationController?.navigationBar.items = [UINavigationItem(title: "Choose a Location")]
